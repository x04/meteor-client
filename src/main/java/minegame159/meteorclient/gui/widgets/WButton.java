...
public class WButton extends WPressable {
    ...
    protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
        ...
        if (text != null) {
            ...
            Color color;
            if (pressed) {
                color = region.pressed;
            } else if (mouseOver) {
                color = region.hovered;
            } else {
                color = region.color;
            }
    ...
    public enum ButtonRegion {
        Edit(Region.EDIT, GuiConfig.INSTANCE.edit, GuiConfig.INSTANCE.editHovered, GuiConfig.INSTANCE.editPressed), Reset(Region.RESET, GuiConfig.INSTANCE.reset, GuiConfig.INSTANCE.resetHovered, GuiConfig.INSTANCE.resetPressed);
