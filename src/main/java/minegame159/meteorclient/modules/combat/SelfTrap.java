...
public class SelfTrap extends ToggleModule {
    ...
    private final Setting<Boolean> turnOff = sgGeneral.add(new BoolSetting.Builder().name("turn-off").description("Toggles when one placed.").defaultValue(false).build());
