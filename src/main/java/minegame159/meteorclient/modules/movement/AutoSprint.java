...
public class AutoSprint extends ToggleModule {
    ...
    public boolean canSprint() {
        ...
        return (mc.player.isOnGround() || mc.player.isSubmergedInWater())
                && !mc.player.isSneaking() && !mc.player.input.jumping
                && mc.player.forwardSpeed > 0f && !mc.player.isSprinting()
                && bl5 && !mc.player.isUsingItem() && !mc.player.hasStatusEffect(StatusEffects.BLINDNESS);
    }
