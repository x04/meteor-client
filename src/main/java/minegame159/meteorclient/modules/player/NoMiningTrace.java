...
public class NoMiningTrace extends ToggleModule {
    ...
    private final Setting<Boolean> onlyWhenHoldingPickaxe = sgGeneral.add(new BoolSetting.Builder().name("only-when-holding-pickaxe").description("Only work when holding a pickaxe.").defaultValue(true).build());
